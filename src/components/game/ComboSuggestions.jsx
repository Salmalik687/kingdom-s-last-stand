...
const COMBOS = [
  {
    ...
    desc: "Archer + Cannon adjacent → fuse into a Siege Ballista. Fast fire + heavy damage.",
    bonus: "MERGE!",
  ...
  },
  {
    ...
    desc: "Two Cannons adjacent → fuse into a War Cannon. Double the devastation, slower but brutal.",
    bonus: "MERGE!",
    color: "text-red-400",
  ...
  },
  {
    ...
    desc: "War Cannon + Siege Ballista → the ultimate weapon. Massive range, insane damage.",
    bonus: "MEGA MERGE!",
    color: "text-rose-300",
